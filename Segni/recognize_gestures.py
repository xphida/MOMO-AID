# -*- coding: utf-8 -*-
"""
Created on Mon May 11 18:26:20 2020
...
def recognize():
	...
	while True:
		...
		#thresh = cv2.adaptiveThreshold(blur,255,cv2.ADAPTIVE_THRESH_GAUSSIAN_C,cv2.THRESH_BINARY,11,2)[1]
		...
		if len(contours) > 0:
			...
			if cv2.contourArea(contour) > 10000:
				...
				#print(text)
				if text is not None: Woody+=text
			else:
				Woodylong+=" "+Woody
				print(Woody)
				Woody=""
		...
		#splitted_text = split_sentence(str(text), 2)
		#put_splitted_text_in_blackboard(blackboard, splitted_text)
		cv2.putText(blackboard, Woody, (30, 200), cv2.FONT_HERSHEY_TRIPLEX, 1.3, (255, 255, 255))
